...
function EWD_URP_Add_Default_Field($Review_Category_Item, $product_name, $Logged_In_User) {
	...
	if ($Review_Category_Item['CategoryName'] == "Product Name (if applicable)") {$ReturnString .= EWD_URP_Add_Product_Name_Field($product_name);}
	elseif ($Review_Category_Item['CategoryName'] == "Review Author") {$ReturnString .= EWD_URP_Add_Author_Field($Logged_In_User);}
	...
	elseif ($Review_Category_Item['CategoryName'] == "Reviewer Email (if applicable)") {$ReturnString .= EWD_URP_Add_Review_Body_Field();}
	elseif ($Review_Category_Item['CategoryName'] == "Review" and $Require_Email == "Yes") {$ReturnString .= EWD_URP_Add_Author_Email_Field();}
	elseif ($Review_Category_Item['CategoryName'] == "Review Image (if applicable)" and $Review_Image == "Yes") {$ReturnString .= EWD_URP_Add_Review_Image_Field();}
...
function EWD_URP_Add_Product_Name_Field($product_name) {
	global $wpdb;
...
function EWD_URP_Add_Author_Field($Logged_In_User) {
...
function EWD_URP_Add_Review_Image_Field() {
	$ReturnString = "";
...
function EWD_URP_Add_Review_Item_Field($Review_Category_Item) {
	...
	elseif ($Review_Score_Input == "Stars") {
		...
		$ReturnString .= "</div>";
		$ReturnString .= "<input type='text' id='ewd-urp-" . $Review_Category_Item['CategoryName'] . "' class='ewd-urp-hidden' name='" . $Review_Category_Item['CategoryName'] . "' value='" . $_POST['Overall_Score'] . "' " . $Required_Text . "/>";
	}
	else {
