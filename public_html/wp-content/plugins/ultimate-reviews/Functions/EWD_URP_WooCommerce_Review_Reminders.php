...
function EWD_URP_Send_Review_Reminder_Email($Order, $Reminder_Item) {
	...
	foreach ($Email_Messages_Array as $Email_Message_Item) {
		if ($Email_Message_Item['ID'] == $Reminder_Item['Email_To_Send']) {
			$Template_Message = EWD_URP_Return_Email_Template($Email_Message_Item);
...
function EWD_URP_Return_Email_Template($Email_Message_Item) {
  $Message_Title = $Email_Message_Item['Name'];
  $Message_Content = EWD_URP_Replace_Email_Content(stripslashes($Email_Message_Item['Message']));
...
function EWD_URP_Replace_Email_Content($Message_Start) {
  ...
  $Final_Message = EWD_URP_Replace_Email_Links($Message);
