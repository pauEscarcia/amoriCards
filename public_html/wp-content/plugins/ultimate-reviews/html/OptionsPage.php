					...
					<tr>
						...
						<td>
							<fieldset><legend class="screen-reader-text"><span>Review Video</span></legend>
								...
								<p>Should there be a field for reviewer to embed a video with their review from an external site (YouTube, Vimeo, etc.)?</p>
							</fieldset>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<fieldset><legend class="screen-reader-text"><span>Match WooCommerce Categories</span></legend>
								...
								<p>Should review catgories match the product categories in WooCommerce, and automatically attach a product's categories to reviews of that product?</p>
							</fieldset>
						</td>
					</tr>
								...
								<table id='ewd-urp-review-categories-table'>
									...
									<tbody>
										...
										foreach ($Review_Categories_Array as $Review_Category_Item) {
											...
											if ($Review_Category_Item['CategoryName'] == "Review") {
