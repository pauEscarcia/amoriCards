...
if ( $rating_count > 0 ) : ?>
	...
	<div class="woocommerce-product-rating">
		...
		<?php if ( comments_open() ) : ?><a href="#reviews" class="woocommerce-review-link" rel="nofollow">(<?php printf( _n( '%s customer review', '%s customer reviews', $review_count, 'woocommerce' ), $review_count ); ?>)</a><?php endif ?>
	</div>
