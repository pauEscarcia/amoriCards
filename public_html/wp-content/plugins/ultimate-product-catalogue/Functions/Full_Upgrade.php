...
function UPCP_Upgrade_To_Full() {
		...
		if ($Key == "EWD Trial" and !get_option("UPCP_Trial_Happening")) {
			$ewd_urp_message = array("Message_Type" => "Update", "Message" => __("Trial successfully started!", 'ultimate-product-catalogue'));
			...
			$message = array("Message_Type" => "Update", "Message" => __("Trial successfully started.", 'ultimate-product-catalogue'));
		}
