...
<p class="submit"><input type="submit" name="submit" id="submit" class="button-primary" value="<?php _e('Add New Product', 'ultimate-product-catalogue') ?>"  /></p></form>
...
<p class="submit"><input type="submit" name="submit" id="submit" class="button-primary" value="<?php _e('Add New Products', 'ultimate-product-catalogue') ?>"  /></p>
</form>
</div>
