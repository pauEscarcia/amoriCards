...
<table id='premium-options' class="form-table upcp-options-table">
	...
	<td>
		...
		<p><?php _e("Should a product's review rating be displayed on the main catalog page? (requires plugin 'Ultimate Reviews')?", 'ultimate-product-catalogue')?></p>
		</fieldset>
	</td>
	</tr>
	<tr>
	...
	<td>
		...
		<p><?php _e("Should a lightbox pop-up on the product page when an image is clicked?", 'ultimate-product-catalogue')?></p>
		</fieldset>
	</td>
	</tr>
	<tr>
...
<p class="submit"><input type="submit" name="Options_Submit" id="submit" class="button button-primary" value='<?php _e("Save Changes", 'ultimate-product-catalogue')?>'/></p></form>
