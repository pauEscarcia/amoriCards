...
if ( !function_exists( 'df_title_post' ) ) {
    ...
    function df_title_post() {
        ...
        $html .= sprintf( '<div class="df-post-title %s">', esc_attr( $align ) );
...
if ( !function_exists( 'df_title_page' ) ) {
    ...
    function df_title_page() {
        ...
        $html  = sprintf( '<div class="df-post-title">', esc_attr( $align ) );
...
if ( !function_exists( 'df_feature_image' ) ) {
    ...
    function df_feature_image() {
        ...
        if ( !has_post_thumbnail() || ( get_post_type() == 'post' && get_theme_mod( 'df_hide_feat_img', 0 ) == 1 ) )
            return;
        ...
        $html .= sprintf( '<div class="featured-media %s">', esc_attr( $col ));
...
if ( !function_exists( 'df_author_biography' ) ) {
    ...
    function df_author_biography() {
        ...
        if ( get_the_author_meta( 'facebook' ) != '') {
            $html .= sprintf( '<li><a target="_blank" class="author-social df-facebook" href="http://facebook.com/%s">Facebook</a></li>', esc_url ( get_the_author_meta( 'facebook' ) ) );
        }

        if ( get_the_author_meta( 'twitter' ) != '') {
            $html .= sprintf( '<li><a target="_blank" class="author-social df-twitter" href="http://twitter.com/%s">Twitter</a></li>', esc_url( get_the_author_meta( 'twitter' ) ) );
        }

        if ( get_the_author_meta( 'instagram' ) != '' ) {
            $html .= sprintf( '<li><a target="_blank" class="author-social df-instagram" href="http://instagram.com/%s">Instagram</a></li>', esc_url( get_the_author_meta( 'instagram' ) ) );
        }
